            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-1 space-y-6 animate-fade-in-up">
                    ...
                    <div class="space-y-4">
                        {{-- Alamat --}}
                        <div
                            class="flex items-start gap-4 p-6 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up animation-delay-200">
                            <div
                                class="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 transform hover:rotate-12 transition-transform duration-300">
                        ...
                        {{-- Email --}}
                        <div
                            class="flex items-start gap-4 p-6 bg-gradient-to-br from-white to-purple-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up animation-delay-300">
                            <div
                                class="w-14 h-14 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 transform hover:rotate-12 transition-transform duration-300">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <a href="mailto:rifqysaputra1102@gmail.com"
                                    class="text-sm text-blue-600 hover:underline break-all transform hover:translate-x-1 inline-block transition-transform duration-300">
                        ...
                        {{-- Phone --}}
                        <div
                            class="flex items-start gap-4 p-6 bg-gradient-to-br from-white to-green-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up animation-delay-400">
                            <div
                                class="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 transform hover:rotate-12 transition-transform duration-300">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <a href="tel:+6285773818846" class="text-sm text-blue-600 hover:underline">
                                    +62 857-7381-8846
                                </a>
                            </div>
                        </div>
                        ...
                        {{-- WhatsApp --}}
                        <div
                            class="flex items-start gap-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            <div
                                class="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    {{-- Business Hours --}}
                    <div class="p-6 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <form wire:submit.prevent="submitContact" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="name" wire:model.blur="name"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('name') @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" wire:model.blur="email"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('email') @enderror"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="tel" id="phone" wire:model.blur="phone"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('phone') @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="subject" wire:model.blur="subject"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('subject') @enderror"
                            ...
                            <div>
                                ...
                                <textarea id="message" wire:model.blur="message" rows="6"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none @error('message') @enderror"
                            ...
                            <div class="p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">PT. Munir Jaya Abadi</p>
                                    </div>
                                </div>
                                ...
                                <div <div class="mt-4 p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl">
                                    <p class="text-sm text-gray-700 font-medium mb-2">📍 Alamat
                                        Lengkap:</p>
