          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
              ...
              <ul>
                ...
                <li class="mb-4">
                  <label for="on_sale" class="flex items-center dark:text-gray-300">
                    ...
                    <span class="text-lg dark:text-gray-400">Di Jual</span>
                  </label>
                </li>
              </ul>
            </div>
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div>
                ...
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="100000000" value="1000000000" step="1000">
                <div class="flex justify-between ">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000, 'IDR') }}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000000000, 'IDR') }}</span>
                ...
                <div class="border border-gray-300 dark:border-gray-700">
                  ...
                  <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                    ...
                    <a wire:click.prevent="addToCart({{ $product->id }})" href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                      ...
                      </svg><span wire:loading.remove wire:target="addToCart({{ $product->id }})">Tambah Ke Keranjang</span><span wire:loading wire:target="addToCart({{ $product->id }})">Menambahkan..</span>
                    </a>
