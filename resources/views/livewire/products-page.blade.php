            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        <h2 class="text-2xl font-bold dark:text-gray-400">Merk</h2>
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <ul>
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live="price_range"
                                ...
                                max="100000000" value="1000000000" step="1000">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000, 'IDR') }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000000000, 'IDR') }}</span>
                                ...
                                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                    ...
                                    <a wire:click.prevent="addToCart({{ $product->id }})" href="#"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            wire:target="addToCart({{ $product->id }})">Tambah Ke Keranjang</span><span
                                            wire:loading
