    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            @foreach ($categories as $category)
                <a class="group flex flex-col bg-white border shadow-md rounded-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02] animate-fade-in-up overflow-hidden relative"
                    ...
                    <div class="p-4 md:p-5 relative z-10">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                ...
                                <div class="ms-3">
                                    <h3
                                        class="group-hover:text-blue-600 text-2xl font-semibold text-gray-800 transition-colors duration-300 transform group-hover:translate-x-2">
                                        {{ $category->name }}
                                    </h3>
                                </div>
                            </div>
                            <div class="ps-3">
                                <svg class="flex-shrink-0 w-5 h-5 transform group-hover:translate-x-2 group-hover:scale-125 transition-all duration-300 text-gray-600 group-hover:text-blue-600"
