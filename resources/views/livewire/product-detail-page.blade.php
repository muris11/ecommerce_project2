...
<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="overflow-hidden bg-white py-11 font-poppins rounded-xl shadow-lg">
                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0 animate-fade-in-up" x-data="{ mainImage: '{{ is_array($product->image) && !empty($product->image) ? url('storage', $product->image[0]) : url('images/no-image.png') }}' }">
                    <div class="sticky top-0 z-50 overflow-hidden">
                        ...
                        <div class="px-6 pb-6 mt-6 border-t border-gray-300">
                            <div
                                class="mt-6 p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5 animate-fade-in-up">
                                <div class="flex flex-col sm:flex-row items-start gap-3 mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor"
                                        class="w-6 h-6 sm:w-7 sm:h-7 text-blue-600 flex-shrink-0 mt-0.5 sm:mt-1 animate-pulse"
                                        viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-base sm:text-lg font-bold text-blue-700 mb-2 animate-fade-in">
                                            Layanan Pengiriman Tersedia</h3>
                                        <p class="text-xs sm:text-sm text-gray-600 mb-4 animate-fade-in"
                                            style="animation-delay: 100ms">
                                            Pilih kurir saat checkout untuk melihat estimasi biaya dan waktu pengiriman
                                        </p>

                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                            <div class="flex items-center gap-2 text-xs sm:text-sm text-gray-700 p-2 rounded-md hover:bg-white/50 transition-all duration-200 transform hover:translate-x-1 animate-fade-in-up"
                ...
                <div class="w-full px-4 md:w-1/2 animate-fade-in-up animation-delay-200">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul:ml-4]">
                            <h2
                                class="max-w-xl mb-6 text-2xl font-bold  md:text-4xl transform hover:scale-105 transition-transform duration-300 bg-gradient-to-r from-gray-900 to-gray-700  bg-clip-text text-transparent">
                                {{ $product->name }}</h2>
                            <p
                            ...
                            <p
                                class="whitespace-pre-line leading-relaxed text-gray-700  hover:text-gray-900  transition-colors duration-300">
                                {!! Str::markdown($product->description ?? '') !!}
                            </p>
                        </div>
                        <div class="w-32 mb-8">
                            <label for=""
                                class="w-full pb-1 text-xl font-semibold text-gray-700 border-b-2 border-blue-300  ">Jumlah</label>
                            <div
                                ...
                                <button wire:click="decreaseQty"
                                    class="w-20 h-full text-gray-600 bg-gray-300 rounded-l-lg outline-none cursor-pointer   hover:text-gray-700  hover:bg-gray-400 transform hover:scale-105 active:scale-95 transition-all duration-300">
                                ...
                                <button wire:click="increaseQty"
                                    class="w-20 h-full text-gray-600 bg-gray-300 rounded-r-lg outline-none cursor-pointer    hover:text-gray-700 hover:bg-gray-400 transform hover:scale-105 active:scale-95 transition-all duration-300">
                                    <span class="m-auto text-2xl font-thin">+</span>
                                </button>
                            </div>
                        </div>
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click="addToCart({{ $product->id }})"
                                class="w-full p-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg lg:w-auto  text-gray-50 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 font-semibold flex items-center justify-center gap-2">
        ...
        <div class="max-w-6xl px-4 py-8 mx-auto md:px-6 animate-fade-in-up animation-delay-400">
            <div class="mb-8 border-b border-gray-200  pb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900  mb-2">Review Pelanggan</h2>
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-600 ">{{ $averageRating }} dari 5</span>
                            <span class="ml-2 text-sm text-gray-500 ">({{ $reviewCount }}
                                review)</span>
                        </div>
                    </div>
                </div>
            ...
            @auth
                <div
                    class="mb-8 bg-white  rounded-xl shadow-md border border-gray-100  p-6 md:p-8">
            ...
            @else
                <div
                    class="mb-8 bg-gradient-to-br from-gray-50 to-gray-100   rounded-xl shadow-md border border-gray-200  p-10 text-center">
                    <div
            ...
            <div class="space-y-6">
                @forelse($recentReviews as $review)
                    <div
                        class="bg-white  rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100  p-6">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                            ...
                            <div
                                class="flex items-center gap-1 bg-yellow-50  px-3 py-2 rounded-lg self-start">
                                @for ($i = 1; $i <= 5; $i++)
                        ...
                        @if ($review->admin_reply)
                            <div
                                class="mt-4 pl-6 border-l-4 border-blue-500 bg-gradient-to-r from-blue-50 via-blue-50/50 to-transparent   p-4 rounded-r-lg">
                                ...
                                <p class="text-sm text-gray-700  leading-relaxed pl-10">
                                    {{ $review->admin_reply }}
                                </p>
                            </div>
                        @endif
                ...
                @empty
                    <div
                        ...
                        <p class="text-gray-600 ">Jadilah yang pertama memberikan review untuk produk
                            ini.</p>
                    </div>
                @endforelse
